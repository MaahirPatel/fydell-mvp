...
${assumptions}`;
  ...
  function calculateValuation(input) {
    var _a;
    const years = (_a = input.years) != null ? _a : 5;
...
Detection: call out the overlap in assumptions or memo, or back the duplicated amount out of your valuation.`;
  ...
  function tickChatTriggers(session) {
    ...
    const finSec = ((_a = session.tabSeconds) == null ? void 0 : _a.financials) || ((_b = session.tabSeconds) == null ? void 0 : _b.Financials) || 0;
  ...
  function finalizeAiUsage(session, params) {
    ...
    const caughtComps = !!((_a = session.plantedErrorFlags) == null ? void 0 : _a.err_exit_multiple_vs_comps) || /(comp|precedent)/.test(corpus2) && /(multiple|haircut|rich|above)/.test(corpus2);
  ...
  function detectError1(session, params) {
    ...
    if ((_a = session.plantedErrorFlags) == null ? void 0 : _a.err_exit_multiple_vs_comps) {
  ...
  function detectError3(session) {
    ...
    if ((_a = session.plantedErrorFlags) == null ? void 0 : _a.err_synergy_double_count) {
