...
import { pilotModeEnabled } from "@/lib/auth/flags";
...
const COPY: Record<SignupPath, { title: string; subtitle: string }> = {
  ...
  fde: {
    ...
    subtitle: "You'll land in your candidate home. Simulations arrive by invitation.",
  },
  partner: {
...
const DEFAULT_COPY = {
  ...
  subtitle: "You'll choose how you use Fydell, as a business or a candidate, right after this.",
};
