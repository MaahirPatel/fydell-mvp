...
const THEME = {
  dark: {
    card: "rounded-xl border border-white/[0.08] bg-[#111214] p-5 sm:p-6",
    eyebrow: "text-[12px] font-semibold uppercase tracking-wider text-violet-300",
    title: "text-xl font-semibold text-[#F4F5F7]",
    muted: "text-[15px] text-white/45",
    body: "text-[15px] leading-relaxed text-white/70",
    heading: "text-[15px] font-semibold text-[#F4F5F7]",
    score: "text-3xl font-bold tabular-nums text-[#F4F5F7]",
    scoreDenom: "text-base font-medium text-white/35",
    markOk: "mt-0.5 text-violet-300",
    markReview: "mt-0.5 text-violet-400",
    track: "h-2 flex-1 overflow-hidden rounded-full bg-white/[0.06]",
    barStrong: "bg-violet-400",
    barMid: "bg-violet-500",
    barLow: "bg-blue-500",
    label: "w-56 shrink-0 text-[14px] text-white/65",
    meta: "w-16 shrink-0 text-right text-[13px] tabular-nums text-white/40",
    bandMeta: "w-32 shrink-0 text-right text-[12px] text-white/35",
    tableHead: "border-b border-white/[0.08] text-[12px] uppercase tracking-wide text-white/35",
    tableRow: "border-b border-white/[0.05]",
    tableCell: "font-medium text-white/85",
    tableMuted: "text-white/55",
    formula: "mt-4 space-y-2 rounded-lg border border-violet-500/20 bg-violet-500/[0.08] p-4 font-mono text-[13.5px] text-white/85",
    inset: "mt-2.5 whitespace-pre-line rounded-lg border border-white/[0.06] bg-white/[0.03] p-4 text-[15px] leading-relaxed text-white/70",
    disclaimer: "px-1 text-[13px] leading-relaxed text-white/35",
    band: {
      strong: "border border-violet-400/30 bg-violet-500/15 text-violet-200",
      established: "border border-blue-400/30 bg-blue-500/15 text-blue-200",
      developing: "border border-white/15 bg-white/[0.06] text-white/70",
      limited: "border border-white/10 bg-white/[0.04] text-white/50",
      insufficient: "border border-white/10 bg-white/[0.03] text-white/40",
    } as Record<string, string>,
  },
  light: {
    card: "rounded-2xl border border-slate-200 bg-white p-5 sm:p-6",
    eyebrow: "text-[12px] font-semibold uppercase tracking-wider text-violet-600",
    title: "text-xl font-semibold text-slate-900",
    muted: "text-[15px] text-slate-500",
    body: "text-[15px] leading-relaxed text-slate-700",
    heading: "text-[15px] font-semibold text-slate-900",
    score: "text-3xl font-bold tabular-nums text-slate-900",
    scoreDenom: "text-base font-medium text-slate-400",
    markOk: "mt-0.5 text-violet-600",
    markReview: "mt-0.5 text-violet-500",
    track: "h-2 flex-1 overflow-hidden rounded-full bg-slate-100",
    barStrong: "bg-violet-500",
    barMid: "bg-violet-400",
    barLow: "bg-blue-500",
    label: "w-56 shrink-0 text-[14px] text-slate-700",
    meta: "w-16 shrink-0 text-right text-[13px] tabular-nums text-slate-500",
    bandMeta: "w-32 shrink-0 text-right text-[12px] text-slate-400",
    tableHead: "border-b border-slate-200 text-[12px] uppercase tracking-wide text-slate-400",
    tableRow: "border-b border-slate-100",
    tableCell: "font-medium text-slate-800",
    tableMuted: "text-slate-600",
    formula: "mt-4 space-y-2 rounded-xl bg-violet-50 p-4 font-mono text-[13.5px] text-slate-800",
    inset: "mt-2.5 whitespace-pre-line rounded-xl bg-slate-50 p-4 text-[15px] leading-relaxed text-slate-700",
    disclaimer: "px-1 text-[13px] leading-relaxed text-slate-400",
    band: {
      strong: "bg-violet-100 text-violet-800",
