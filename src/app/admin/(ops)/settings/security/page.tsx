  ...
  return (
    <div className="max-w-2xl">
      ...
      <div className="mt-8 rounded-[var(--radius-panel)] border border-[var(--border-default)] bg-[var(--surface-raised)] p-5 text-[14px]">
        ...
        <ol className="mt-5 list-decimal space-y-2 pl-5 text-[var(--text-secondary)]">
          <li>
            Ensure <code className="text-[var(--text-primary)]">admin@fydell.com</code> has accepted the
          ...
          <li>
            Set <code className="text-[var(--text-primary)]">ADMIN_MFA_REQUIRED=true</code> in Vercel after
