...
export default function FdeOverviewPage() {
  return (
    <div>
      ...
      <p className="mt-2 max-w-[52ch] text-[14px] leading-relaxed text-white/55">
        Missions arrive by invitation only. Check your invitations, or wait for an employer to
        invite you into a mission.
      </p>
      ...
      <section className="mt-8 rounded-[18px] border border-dashed border-white/15 bg-[#0A0C11]/80 px-6 py-14 text-center">
        ...
        <p className="mx-auto mt-3 max-w-[42ch] text-[14px] leading-relaxed text-white/55">
          When an employer invites you to a mission, it will show up in your invitations.
        </p>
        <Link
          href="/app/fde/invitations"
